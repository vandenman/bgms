...
% --- Title (bottom-left, within safe zone) ---
...
\node[anchor=west, text=teal, font=\fontfamily{phv}\selectfont\fontsize{20}{20}\selectfont]
  at (0.9, 2.0) {Bayesian Analysis of Graphical Models};

% =================================================================
% NETWORK (top-right, scaled up to fill)
% =================================================================

\coordinate (n1) at (9.0, 8.2);
\coordinate (n2) at (12.0, 8.8);
\coordinate (n3) at (15.0, 7.8);
\coordinate (n4) at (18.2, 8.5);
\coordinate (n5) at (10.5, 5.2);
\coordinate (n6) at (13.5, 4.2);
\coordinate (n7) at (16.5, 5.5);
\coordinate (n8) at (19.2, 4.5);
\coordinate (n9) at (12.5, 6.8);
\coordinate (n10) at (16.0, 6.3);
