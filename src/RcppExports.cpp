...
// sample_ggm
Rcpp::List sample_ggm(const Rcpp::List& inputFromR, const arma::mat& prior_inclusion_prob, const arma::imat& initial_edge_indicators, const int no_iter, const int no_warmup, const int no_chains, const bool edge_selection, const int seed, const int no_threads, const int progress_type, const std::string& edge_prior, const double beta_bernoulli_alpha, const double beta_bernoulli_beta, const double beta_bernoulli_alpha_between, const double beta_bernoulli_beta_between, const double dirichlet_alpha, const double lambda, const bool na_impute, const Rcpp::Nullable<Rcpp::IntegerMatrix> missing_index_nullable, const std::string& pairwise_prior, const double pairwise_scale, const double blasso_shape, const double blasso_rate, const std::string& diagonal_prior, const double diagonal_prior_rate);
RcppExport SEXP _bgms_sample_ggm(SEXP inputFromRSEXP, SEXP prior_inclusion_probSEXP, SEXP initial_edge_indicatorsSEXP, SEXP no_iterSEXP, SEXP no_warmupSEXP, SEXP no_chainsSEXP, SEXP edge_selectionSEXP, SEXP seedSEXP, SEXP no_threadsSEXP, SEXP progress_typeSEXP, SEXP edge_priorSEXP, SEXP beta_bernoulli_alphaSEXP, SEXP beta_bernoulli_betaSEXP, SEXP beta_bernoulli_alpha_betweenSEXP, SEXP beta_bernoulli_beta_betweenSEXP, SEXP dirichlet_alphaSEXP, SEXP lambdaSEXP, SEXP na_imputeSEXP, SEXP missing_index_nullableSEXP, SEXP pairwise_priorSEXP, SEXP pairwise_scaleSEXP, SEXP blasso_shapeSEXP, SEXP blasso_rateSEXP, SEXP diagonal_priorSEXP, SEXP diagonal_prior_rateSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< const std::string& >::type pairwise_prior(pairwise_priorSEXP);
    Rcpp::traits::input_parameter< const double >::type pairwise_scale(pairwise_scaleSEXP);
    Rcpp::traits::input_parameter< const double >::type blasso_shape(blasso_shapeSEXP);
    Rcpp::traits::input_parameter< const double >::type blasso_rate(blasso_rateSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type diagonal_prior(diagonal_priorSEXP);
    Rcpp::traits::input_parameter< const double >::type diagonal_prior_rate(diagonal_prior_rateSEXP);
