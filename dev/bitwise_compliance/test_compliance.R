...
#
# Usage:
#   Rscript dev/bitwise_compliance/test_compliance.R
#
# Prerequisites:
#   Rscript dev/bitwise_compliance/generate_fixtures.R
#
# Exit code:
...
fixture_dir = file.path("dev", "fixtures", "compliance")

if(!file.exists(file.path(fixture_dir, "manifest.rds"))) {
  stop("No fixtures found. Run dev/bitwise_compliance/generate_fixtures.R first.")
}
